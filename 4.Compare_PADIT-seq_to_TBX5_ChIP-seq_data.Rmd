...
#
df1 <- TBX5_PBM_Escores_PADIT[,c("X8.mer", "Median_baseMean", "Mean_log2FC", "padj", "MPRAactivity")]
colnames(df1) <- c("TFBS", "baseMean", "log2FoldChange", "padj", "MPRAactivity")
df2 <- TBX5_PBM_Escores_PADIT[,c("X8.mer.1", "Median_baseMean", "Mean_log2FC", "padj", "MPRAactivity")]
colnames(df2) <- c("TFBS", "baseMean", "log2FoldChange", "padj", "MPRAactivity")
dds_results_TBX5_df <- rbind(df1, df2)
```


# Tile PADIT-seq TBX5 8-mers on ChIP-seq peaks
```{r}
######################################################### Actual ChIP-seq peaks
# Read TBX5 CHIP-seq DNA sequences
TBX5_CHIP <- read.table(paste(paste(Working_dir, "Input_Files/ChIP-seq_data_TBX5", sep = "/"), "GSE85628.TBX5.cardiomyocyte.bed.fa.txt", sep = "/"), header = FALSE)
...
for(i in 1:numPeaks)
{
  ...
  Heatmap_DF_log2FC <- c(Heatmap_DF_log2FC, list(dds_results_TBX5_df_subset$log2FoldChange))
  Heatmap_DF_MPRAactivity <- c(Heatmap_DF_MPRAactivity, list(dds_results_TBX5_df_subset$MPRAactivity))
}

# Write
saveRDS(Heatmap_DF_log2FC, file=paste(paste(Working_dir, "Output_Files", sep = "/"), "log2FC_8bpstiling_TBX5_peaks_FDR_0.05.RData", sep = "/"))
saveRDS(Heatmap_DF_MPRAactivity, file=paste(paste(Working_dir, "Output_Files", sep = "/"), "MPRAactivity_8bpstiling_TBX5_peaks_FDR_0.05.RData", sep = "/"))
rm(TBX5_CHIP)
...
```{r}
# Read TBX5 CHIP-seq DNA sequences
TBX5_CHIP_OG <- read.table(paste(paste(Working_dir, "Input_Files/ChIP-seq_data_TBX5", sep = "/"), "GSE85628.TBX5.cardiomyocyte.bed.fa.txt", sep = "/"), header = FALSE)

# Read TBX5 CHIP-seq DNA sequences
TBX5_CHIP <- read.table(paste(paste(Working_dir, "Input_Files/ChIP-seq_data_TBX5", sep = "/"), "seq.tsv", sep = "/"), header = FALSE)
TBX5_CHIP <- TBX5_CHIP[which(! TBX5_CHIP$V2 %in% TBX5_CHIP_OG$V1),]
TBX5_CHIP <- TBX5_CHIP[which(TBX5_CHIP$V1 %in% c(paste(1:nrow(TBX5_CHIP_OG), "local+1", sep = "-")) ), ]
colnames(TBX5_CHIP) <- c("V2", "V1")
...
# Write
saveRDS(Heatmap_DF_log2FC, file=paste(paste(Working_dir, "Output_Files", sep = "/"), "log2FC_8bpstiling_TBX5_peaks_HomerBG_FDR_0.05.RData", sep = "/"))
saveRDS(Heatmap_DF_MPRAactivity, file=paste(paste(Working_dir, "Output_Files", sep = "/"), "MPRAactivity_8bpstiling_TBX5_peaks_HomerBG_FDR_0.05.RData", sep = "/"))
rm(TBX5_CHIP)
...
# Tile PADIT-seq TBX5 8-mers on shuffled peaks (bedtools)
```{r}
# Read TBX5 CHIP-seq DNA sequences
TBX5_CHIP <- read.table(paste(paste(Working_dir, "Input_Files/ChIP-seq_data_TBX5", sep = "/"), "GSE85628.TBX5.cardiomyocyte.shuffled1.bed.fa.txt", sep = "/"), header = FALSE)
colnames(TBX5_CHIP) <- c("V1")
...
# Write
saveRDS(Heatmap_DF_log2FC, file=paste(paste(Working_dir, "Output_Files", sep = "/"), "log2FC_8bpstiling_TBX5_peaks.shuffled1_FDR_0.05.RData", sep = "/"))
saveRDS(Heatmap_DF_MPRAactivity, file=paste(paste(Working_dir, "Output_Files", sep = "/"), "MPRAactivity_8bpstiling_TBX5_peaks.shuffled1_FDR_0.05.RData", sep = "/"))
rm(TBX5_CHIP)
```
...
```{r}
# Read TBX5 CHIP-seq DNA sequences
TBX5_CHIP <- read.table(paste(paste(Working_dir, "Input_Files/ChIP-seq_data_TBX5", sep = "/"), "GSE85628.TBX5.cardiomyocyte.shuffled2.bed.fa.txt", sep = "/"), header = FALSE)
colnames(TBX5_CHIP) <- c("V1")
...
# Write
saveRDS(Heatmap_DF_log2FC, file=paste(paste(Working_dir, "Output_Files", sep = "/"), "log2FC_8bpstiling_TBX5_peaks.shuffled2_FDR_0.05.RData", sep = "/"))
saveRDS(Heatmap_DF_MPRAactivity, file=paste(paste(Working_dir, "Output_Files", sep = "/"), "MPRAactivity_8bpstiling_TBX5_peaks.shuffled2_FDR_0.05.RData", sep = "/"))
rm(TBX5_CHIP)
```


# TBX5 ChIP-seq peaks contain longer stretches of consecutively active TBX5 8-mers
```{r}
# Read log2FC tiling
log2FC_peaks <- readRDS(paste(paste(Working_dir, "Output_Files", sep = "/"), "log2FC_8bpstiling_TBX5_peaks_FDR_0.05.RData", sep = "/"))
log2FC_HomerBG <- readRDS(paste(paste(Working_dir, "Output_Files", sep = "/"), "log2FC_8bpstiling_TBX5_peaks_HomerBG_FDR_0.05.RData", sep = "/"))
log2FC_Shuffled1 <- readRDS(paste(paste(Working_dir, "Output_Files", sep = "/"), "log2FC_8bpstiling_TBX5_peaks.shuffled1_FDR_0.05.RData", sep = "/"))
log2FC_Shuffled2 <- readRDS(paste(paste(Working_dir, "Output_Files", sep = "/"), "log2FC_8bpstiling_TBX5_peaks.shuffled2_FDR_0.05.RData", sep = "/"))

# Read MPRAactivity tiling
MPRAactivity_peaks <- readRDS(paste(paste(Working_dir, "Output_Files", sep = "/"), "MPRAactivity_8bpstiling_TBX5_peaks_FDR_0.05.RData", sep = "/"))
MPRAactivity_HomerBG <- readRDS(paste(paste(Working_dir, "Output_Files", sep = "/"), "MPRAactivity_8bpstiling_TBX5_peaks_HomerBG_FDR_0.05.RData", sep = "/"))
MPRAactivity_HomerBG <- rapply(MPRAactivity_HomerBG, f=function(x) ifelse(is.na(x),0,x), how="replace" )
MPRAactivity_Shuffled1 <- readRDS(paste(paste(Working_dir, "Output_Files", sep = "/"), "MPRAactivity_8bpstiling_TBX5_peaks.shuffled1_FDR_0.05.RData", sep = "/"))
MPRAactivity_Shuffled2 <- readRDS(paste(paste(Working_dir, "Output_Files", sep = "/"), "MPRAactivity_8bpstiling_TBX5_peaks.shuffled2_FDR_0.05.RData", sep = "/"))
...
hist(longest1s_perPeak_Shuffled_random, breaks = 20, prob = FALSE, col = "black", ylim = c(0, 6000),
...
# Histogram (longest 1's of MPRAactivity) 
hist(longest1s_perPeak_Shuffled_random1, breaks = 20, prob = FALSE, col = "black", ylim = c(0, 6000),
     xlim = c(0, 10), xlab = "Number of 8-mers with PADIT-seq activity", 
...
```{r}
process_peak <- function(peak_data, dds_results_TBX5_df, max_length) {
  ...
  dds_results_TBX5_df_subset <- dds_results_TBX5_df[dds_results_TBX5_df$TFBS %in% Sequence_10mers_DF$V1, ]
  dds_results_TBX5_df_subset <- dds_results_TBX5_df_subset[match(Sequence_10mers_DF$V1, dds_results_TBX5_df_subset$TFBS), ]
  
  Longest_1s_results <- Longest_1s(dds_results_TBX5_df_subset$MPRAactivity)
  
  if(Longest_1s_results$max_length == max_length && 
     Longest_1s_results$start_position > 4 && 
     (Longest_1s_results$start_position + max_length + 10) < nrow(dds_results_TBX5_df_subset)) {
    
    log2FC <- dds_results_TBX5_df_subset$log2FoldChange[
...
TBX5_CHIP <- read.table(paste(paste(Working_dir, "Input_Files/ChIP-seq_data_TBX5", sep = "/"), "GSE85628.TBX5.cardiomyocyte.bed.fa2.0.txt", sep = "/"))
TBX5_CHIP <- TBX5_CHIP[complete.cases(TBX5_CHIP), ]
colnames(TBX5_CHIP) <- c("chr", "start", "end", "DNA")

# Initialize lists to store results
results_list <- list(DF3 = list(), DF4 = list(), DF5 = list())

# Process each peak
for(i in 1:nrow(TBX5_CHIP)) {
  for(max_length in 3:5) {
    result <- process_peak(TBX5_CHIP[i, ], dds_results_TBX5_df, max_length)
    if (!is.null(result)) {
...
write.table(DF3, file = paste(paste(Working_dir, "Output_Files", sep = "/"), "GSE85628.TBX5.cardiomyocyte.bed.fa2.0_3consecutive8mers_and4bpsFlank_log2FC.bed", sep = "/"), col.names = FALSE, row.names = FALSE, quote = FALSE, sep = "\t")
write.table(DF4, file = paste(paste(Working_dir, "Output_Files", sep = "/"), "GSE85628.TBX5.cardiomyocyte.bed.fa2.0_4consecutive8mers_and4bpsFlank_log2FC.bed", sep = "/"), col.names = FALSE, row.names = FALSE, quote = FALSE, sep = "\t")
write.table(DF5, file = paste(paste(Working_dir, "Output_Files", sep = "/"), "GSE85628.TBX5.cardiomyocyte.bed.fa2.0_5consecutive8mers_and4bpsFlank_log2FC.bed", sep = "/"), col.names = FALSE, row.names = FALSE, quote = FALSE, sep = "\t")
...
#
DF3 <- read.table(paste(paste(Working_dir, "Output_Files", sep = "/"), "GSE85628.TBX5.cardiomyocyte.bed.fa2.0_3consecutive8mers_and4bpsFlank_log2FC.bed", sep = "/"), header = FALSE)
Generate_PWM_seqlogo(substr(DF3$V4, 2, 17), 16)

#
DF4 <- read.table(paste(paste(Working_dir, "Output_Files", sep = "/"), "GSE85628.TBX5.cardiomyocyte.bed.fa2.0_4consecutive8mers_and4bpsFlank_log2FC.bed", sep = "/"), header = FALSE)
Generate_PWM_seqlogo(substr(DF4$V4, 2, 18), 17)

#
DF5 <- read.table(paste(paste(Working_dir, "Output_Files", sep = "/"), "GSE85628.TBX5.cardiomyocyte.bed.fa2.0_5consecutive8mers_and4bpsFlank_log2FC.bed", sep = "/"), header = FALSE)
